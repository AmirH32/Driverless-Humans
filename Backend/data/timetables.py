...
def get_timetables_by_stop_and_route(stop_id, route_id):
    ...
    bus_locations["arrival_time"] = bus_locations["time"] + pd.to_timedelta(
        bus_locations["arrival_min"], unit="m"
    )
    bus_locations["arrival_time"] = bus_locations["arrival_time"].apply(
